...
class UserManagerDBTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Tests UserManagerDB::searchByCriteria()
     */
    public function testSearchByCriteria()
    {
        // TODO Auto-generated UserManagerDBTest::testSearchByCriteria()
        $this->markTestIncomplete("searchByCriteria test not implemented");

        UserManagerDB::searchByCriteria(/* parameters */);
    }

    /**
     * Tests UserManagerDB->searchSQL()
     */
    public function testSearchSQL()
    {
        // TODO Auto-generated UserManagerDBTest->testSearchSQL()
        $this->markTestIncomplete("searchSQL test not implemented");

        $this->userManagerDB->searchSQL(/* parameters */);
    }
