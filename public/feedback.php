...
if (isset($_POST["submitted"])) {
    ...
    if (empty($error_firstname) && empty($error_lastname) && empty($error_email) && empty($error_comments)) {
        ...
        header("Location:thankyou.php?firstname=" . $firstname . "&lastname=" . $lastname);
    }
}
?>
...
<form name="myForm" method="post" class="pure-form pure-form-stacked">
	...
	<table width="800">
		...
		<tr>
			<td></td>
			<td><br> <input type="submit" name="submitted" value="Submit"
				class="pure-button pure-button-primary"> <input type="reset"
				name="reset" value="Reset" class="pure-button pure-button-primary">
			</td>
		</tr>
	</table>
	<div><?=$formerror?></div>
