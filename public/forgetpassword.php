...
if(isset($_POST["submitted"])){
	...
	if(isset($existuser)){
			...
			$mail->addAddress('sajanrajah@gmail.com', 'User1');
			
			 
			/* Subject */
			$mail->Subject = 'ACWD Test Email';
			...
			/* Message body */
			$mail->Body = "You have requested a new password. This is your new password: ".$newpassword[0];
